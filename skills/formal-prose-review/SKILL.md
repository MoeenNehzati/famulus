...
If the document includes a top-of-document comment block or other explicit profile information, read `../../references/document-standards/document-profile.md` and compare the block to the shared standard.
