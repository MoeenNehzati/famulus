...
def main(argv: list[str] | None = None) -> None:
    ...
    .ElkHtmlRenderer:
      why:
        constructs: "Creates the shared renderer, carrying the default quick guide, used for validation, reduction, and HTML output."
    """
    ...
    renderer = ElkHtmlRenderer(quick_guide=DEFAULT_QUICK_GUIDE)
