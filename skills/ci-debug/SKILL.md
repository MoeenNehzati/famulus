---
name: ci-debug
description: Use when a local branch must be qualified or repaired against GitHub Actions, CI is red, matrix failures need isolation, or repeated full reruns make diagnosis inefficient.
---
