"""Validate version-4 behavioral-source dependencies named in instruction text."""
...
def _used_module_ids(
    ...
    used: set[str] = set()
    local_sources = set(graph.module_sources.get(module_id, ()))
    source_modules = {
        source_id: owner_id
...
def validate(repo_root: Path) -> list[str]:
    ...
    modules = {
        ...
        and node.skill_root.parent == repo_root / "skills"
    }
