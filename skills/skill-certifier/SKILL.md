...
Uses Interfaces:
- `skill-certifier.source.gateway -> skill-certifier.source.rtx-audit-certifier.interface.certify@1`
- `skill-certifier.source.rtx-audit-certifier -> common.interface.artifact-health@1`
- `skill-certifier.source.rtx-audit-certifier -> common.interface.atomic-files@1`
- `skill-certifier.source.rtx-audit-certifier -> common.interface.audit-records@1`
- `skill-certifier.source.rtx-audit-certifier -> common.interface.blueprint-graph@1`
- `skill-certifier.source.rtx-audit-certifier -> common.interface.certification-view@1`
- `skill-certifier.source.rtx-audit-certifier -> common.interface.git-provenance@1`
- `skill-certifier.source.rtx-audit-certifier -> common.interface.pooled-blueprint@1`
- `skill-certifier.source.rtx-audit-certifier -> skill-drift.interface.compute-hashes@1`
- `skill-certifier.source.rtx-audit-certifier -> skill-drift.interface.drift-status@1`
- `skill-certifier.source.rtx-audit-certifier -> skill-maker.interface.sync-blueprints@1`
...
- `skill-certifier.interface.certify` — Audit exact target closures and incrementally write commit-backed node health records.
...
- `skill-certifier.interface.default` — Audit exact target closures and report semantic and commit-backed stamp outcomes.
...
Mechanical certification runs through `skill-certifier.interface.certify`; that
...
5. The LLM invocation supplies semantic attestation for the reviewed commit.
   ...
   check record or generated semantic default. For live v4 finalization, pass
   the exact repository root as `--reviewed-repository` and the exact reviewed
   commit as `--reviewed-commit`; the machine finalizer must not infer either
   value from its current checkout.
