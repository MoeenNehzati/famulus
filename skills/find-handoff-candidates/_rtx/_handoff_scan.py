...
parser files under this same directory (see the queried
``skill-guidelines.assistant-neutrality`` rule for why this script itself must stay host-neutral): each
