...
2. operation-specific construction and execution semantic capabilities for
   public `officina.rutter.Rutter`, `officina.rutter.Voyage`, and
...
must name `officina.rutter.Rutter` or another explicitly declared public
...
public Python exports `officina.rutter.Rutter`, `officina.rutter.Voyage`, and
`officina.rutter.VoyageDispenser` are present. The deterministic probe reports
these exact absent contract fields:
