# Unavailable runtime capability false-success claim
...
logic:
  enforcement_matrix:
    - obligation_id: obl-approval
      ...
      public_runtime_capability: rutter.interface.owner-decision
      ...
      postcondition: owner evidence selects a successor
      failure_result: the named interface is absent
      ...
      negative_trace:
        ...
        evidence_ref: input.evidence
        outcome: unavailable
        expected: {kind: rejection, rejection_code: capability-unavailable}
```
