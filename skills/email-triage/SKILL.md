...
- `email-triage.interface.scripts-update-watermark` — Advance the triage watermark to the current timestamp. Refuses if scripts-mark-failure was called earlier in this run.
  - `dispatcher --caller-skill email-triage email-triage.interface.scripts-update-watermark`
