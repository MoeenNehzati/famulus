...
SKILL_ROOT = REPO_ROOT / "skills" / "daily-plan"

BLUEPRINT_FILES = [
    SKILL_ROOT / "blueprints" / "rtx-plan-orchestrate.yaml",
    SKILL_ROOT / "blueprints" / "rtx-plan-storage.yaml",
    SKILL_ROOT / "blueprints" / "rtx-state-patch.yaml",
]
