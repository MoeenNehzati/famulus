...
- Setup `list-manager.interface.setup@1` routes to `begin(setup, list-manager.interface.setup, ORIGINAL_CALLER, ORIGINAL_INTERFACE, ORIGINAL_VERSION)`.
...
`bootstrap-dispatcher-runtime.interface.repair-selected-packages` for list-manager's exact
