...
SKILL_ROOT = TEST_PARENT.parent if TEST_PARENT.name == "_rtx" else TEST_PARENT
RUNTIME_ROOT = (
    TEST_PARENT if TEST_PARENT.name == "_rtx" else SKILL_ROOT / "_rtx"
)
REPO_ROOT = SKILL_ROOT.parents[1]
MODULE_PATH = RUNTIME_ROOT / "_category_cache.py"
TODO_YAML = """\
schema: todo
name: todo
categories:
