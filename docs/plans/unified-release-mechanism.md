...
action. Implementation must add the operative checklist at
`docs/releasing.md`; that file does not exist yet.
...
- `docs/releasing.md` contains the exact commands for checking, tagging,
  pushing, publishing, updating, and withdrawing;
- CI runs the identity check; and
- one public Claude install and one public Codex install have been verified
