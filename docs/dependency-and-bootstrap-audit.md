...
| `src/officina/visualization/html_renderer/vendor/mathjax-3.2.2-tex-svg-full.js` | npm `mathjax@3.2.2`; Git `600692ad9d3552cc25f85510d5797bc942ecc9f7` | Apache-2.0 | Exact npm-package match; SHA-256 `a4354ff94fd868aea0cc6eaaa79a57fda0588646fc46ee3700a349ee0a11cbe6`. Full build: bundles every TeX extension so a self-contained page never needs to fetch one at render time |
