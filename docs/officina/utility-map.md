...
| Assistant access | `officina.install.assistant_access` | Grants a launched installed assistant its managed roots. Checkout-local development activation is owned by the `dev-activation` skill. |
