...
def lifecycle_lock_path(state_root: Path) -> Path:
    return state_root / ".ai-recurring-lifecycle.lock"
...
__all__ = ["ManagedSchedule", "RecurringPrerequisiteError", "RecurringRuntimeError", "build_managed_schedule", "lifecycle_lock_path", "load_managed_schedule", "load_public_schedule", "write_managed_schedule"]
