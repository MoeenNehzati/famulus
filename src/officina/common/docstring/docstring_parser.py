...
def _resolve_docstring_syntax_path(path: str | Path | None = None) -> Path | None:
    ...
    InstantiationsFromRepo
    ----------------------
    .docstring_policy.resolve_docstring_schema_path:
      why:
...
def load_docstring_schema(path: str | Path | None = None) -> DocstringSchema:
    ...
    keeps configuration and profile materialization in docstring_policy.
    ...
    - none
    """
    from .docstring_policy import load_docstring_schema as _load_docstring_schema
