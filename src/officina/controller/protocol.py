...
Role
----
``officina.controller.model`` defines the controller's private graph,
...
inspecting a :class:`~officina.controller.model.ControllerSnapshot` or
...
from .model import ControllerStatus, InstructionAction, JsonValue
