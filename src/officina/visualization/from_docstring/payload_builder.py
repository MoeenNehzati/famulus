...
from officina.docstring.parser import FunctionSpec, PipelineSpec
from officina.docstring.parser import parse_pseudocode_dependency_ref
    ...
    *,
    ...
    return {
        ...
        "document": {
            ...
            "generated_by": "officina.visualization.from_docstring.json_extractor",
