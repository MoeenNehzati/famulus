...
def test_live_node_standard_import_pins_match_raw_repository_bytes() -> None:
    standards = {"node": (Path("references/node-standards/node.standard.yaml"), "node-standards.node", "2.0.0", 16), "module": (Path("references/node-standards/module.standard.yaml"), "node-standards.module", "2.0.0", 17), "behavioral-source": (Path("references/node-standards/behavioral-source.standard.yaml"), "node-standards.behavioral-source", "1.0.0", 17), "instruction-node": (Path("references/node-standards/instruction-node.standard.yaml"), "node-standards.instruction-node", "1.0.0", 17),
        "python-node": (Path("references/node-standards/python-node.standard.yaml"), "node-standards.python-node", "1.0.0", 20), "instruction-module": (Path("references/node-standards/instruction-module.standard.yaml"), "node-standards.instruction-module", "1.0.0", 21), "python-module": (Path("references/node-standards/python-module.standard.yaml"), "node-standards.python-module", "1.0.0", 23), "instruction-behavioral-source": (Path("references/node-standards/instruction-behavioral-source.standard.yaml"), "node-standards.instruction-behavioral-source", "1.0.0", 19),
        "python-behavioral-source": (Path("references/node-standards/python-behavioral-source.standard.yaml"), "node-standards.python-behavioral-source", "1.0.0", 22), "refactoring": (Path("references/node-standards/refactoring.standard.yaml"), "node-standards.refactoring", "2.0.0", 7), "python-ood": (Path("references/node-standards/python-ood.standard.yaml"), "node-standards.python-ood", "1.0.0", 6)}
