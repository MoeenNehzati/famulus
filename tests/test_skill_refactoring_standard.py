...
EXPECTED_SMELLS = {
    ...
    "missing-contract-artifacts": ("Missing or incomplete interface artifacts", "missing `blueprint.yaml`", "Missing interface declaration."),
...
EXPECTED_REMEDIES = {
    ...
    "sync-generated-contract-artifacts": ("Sync generated interface artifacts", "regenerate the generated interface block", None, "medium"),
    "add-fix-blueprint": ("Add/fix blueprint", "Create or correct `blueprint.yaml`", "interface artifacts remain complete and synchronized", "low"),
